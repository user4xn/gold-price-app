...
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
    const formValidationCustom = document.getElementById('formValidationCustom'),
      formValidationSelect2Ele = jQuery(formValidationCustom.querySelector('[name="formValidationSelect2"]')),
      formValidationTechEle = jQuery(formValidationCustom.querySelector('[name="formValidationTech"]')),
      formValidationLangEle = formValidationCustom.querySelector('[name="formValidationLang"]'),
      formValidationHobbiesEle = jQuery(formValidationCustom.querySelector('.selectpicker')),
      tech = [
        'ReactJS',
        'Angular',
        'VueJS',
    ...
    const fv = FormValidation.formValidation(formValidationCustom, {
      fields: {
        currentPassword: {
          validators: {
            notEmpty: {
    ...
    // Flatpickr
    flatpickr(formValidationCustom.querySelector('[name="formValidationDob"]'), {
      enableTime: false,
