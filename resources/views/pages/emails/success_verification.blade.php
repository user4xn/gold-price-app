      ...
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-4 p-sm-5">
          <div class="w-px-400 mx-auto">
            <h3 class="mb-1 fw-bold">Verifikasi email berhasil ✉️</h3>
            <p class="text-start mb-4">
                Terimakasih telah mengkonfirmasi alamat email kamu, kamu sekarang mempunyai akses untuk masuk ke dashboard
            </p>
            <a class="btn btn-primary w-100 mb-3" href="/login"> Login </a>
          </div>
        </div>
      </div>
    </div>
